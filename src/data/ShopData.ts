...
export const COIN_PACKS: CoinPack[] = [
  {
    ...
    category: 'coins',
    iapPrice: '$0.99',
    iapProductId: 'com.phonoinc.app.coins.handful',
    icon: 'money-bag',
    coinAmount: 400,
    bonusCoins: 100,
    rarity: 'common',
  },
  {
    ...
    category: 'coins',
    iapPrice: '$2.99',
    iapProductId: 'com.phonoinc.app.coins.pouch',
    icon: 'money-bag',
    coinAmount: 1400,
    bonusCoins: 600,
    rarity: 'rare',
  },
  {
    ...
    category: 'coins',
    iapPrice: '$6.99',
    iapProductId: 'com.phonoinc.app.coins.chest',
    icon: 'trophy',
    coinAmount: 3500,
    bonusCoins: 2000,
    rarity: 'epic',
  },
  {
    ...
    category: 'coins',
    iapPrice: '$14.99',
    iapProductId: 'com.phonoinc.app.coins.trove',
    icon: 'diamond',
    coinAmount: 8000,
    bonusCoins: 6000,
    rarity: 'legendary',
  },
  {
    ...
    category: 'coins',
    iapPrice: '$29.99',
    iapProductId: 'com.phonoinc.app.coins.hoard',
...
export const STARTER_BUNDLES: StarterBundle[] = [
  {
    ...
    category: 'bundles',
    iapPrice: '$2.99',
    iapProductId: 'com.phonoinc.app.bundle.welcome',
    icon: 'bundle-welcome',
    rarity: 'rare',
    contents: {
      coins: 1500,
  ...
  },
  {
    ...
    category: 'bundles',
    iapPrice: '$4.99',
    iapProductId: 'com.phonoinc.app.bundle.egghunter',
    icon: 'bundle-starter',
    rarity: 'epic',
    contents: {
      coins: 1000,
  ...
  },
  {
    ...
    category: 'bundles',
    iapPrice: '$14.99',
    iapProductId: 'com.phonoinc.app.bundle.islandmaster',
    icon: 'treasure-chest',
    rarity: 'legendary',
    contents: {
      coins: 5000,
