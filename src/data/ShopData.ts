...
export const UTILITY_ITEMS: UtilityItem[] = [
  ...
  },
  {
    ...
    description: 'Guarantee your next pet is your wished species!',
    category: 'utilities',
    coinPrice: 2000,
    icon: 'target',
    rarity: 'legendary',
...
export const BACKGROUND_BUNDLES: Bundle[] = [
  {
    ...
    totalValue: 3800, // Sum of individual prices: 800+800+1000+1000+1200
    savings: '26%',
  },
];
...
// Shop categories for UI - 4 tabs: Eggs, Themes, Boosts, Featured
