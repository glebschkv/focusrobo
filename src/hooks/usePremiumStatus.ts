...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  ...
  },
  {
    ...
    iapProductId: 'co.botblock.app.premiumplus.monthly',
    bonusCoins: 1500,
  },
  {
    ...
    iapProductId: 'co.botblock.app.premiumplus.yearly',
    savings: 'Save 40%',
    bonusCoins: 5000,
  },
  {
...
export const BATTLE_PASS_PLANS = [
  {
    ...
    price: '€4,99',
    priceValue: 4.99,
    iapProductId: 'co.botblock.app.battlepass.premium',
  },
  {
    ...
    price: '€9,99',
    priceValue: 9.99,
    iapProductId: 'co.botblock.app.battlepass.premium.plus',
    bonusTiers: 10,
  },
];
