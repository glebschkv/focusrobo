          ...
          <div>
            <div className="settings-slider-label">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-[#E8F0EB]">Daily Goal</span>
              </div>
          ...
          <div>
            <div className="settings-slider-label">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-[#E8F0EB]">Weekly Goal</span>
              </div>
              <span className="text-sm font-bold text-[#8BA68F]">{formatDuration(settings.weeklyGoalMinutes * 60)}</span>
            </div>
      ...
      <div className="settings-card">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <Label className="text-sm font-bold text-[#E8F0EB]">Reset Analytics</Label>
              <p className="text-[11px] text-[#8BA68F]">Clear all tracked data</p>
            </div>
          </div>
          <button
            className="px-3 py-1.5 rounded-lg text-xs font-bold transition-all active:scale-95"
            style={{ background: 'rgba(196,100,100,0.1)', border: '1px solid rgba(196,100,100,0.25)', color: '#E57373' }}
        ...
        <div className="settings-dialog-overlay">
          ...
          <div className="settings-dialog-card space-y-4">
            <div className="space-y-2 text-center">
              <h2 className="text-base font-bold text-[#E8F0EB]">Reset Analytics?</h2>
              <p className="text-xs text-[#8BA68F]">Are you sure you want to reset all analytics data? This cannot be undone.</p>
            </div>
