      ...
      invoke: vi.fn().mockResolvedValue({
        data: {
          ...
          subscription: {
            ...
            productId: 'co.phonoinc.app.premium.monthly',
            environment: 'sandbox',
          },
        },
        error: null,
...
const mockProducts = [
  {
    id: 'co.phonoinc.app.premium.weekly',
  ...
  {
    id: 'co.phonoinc.app.premium.monthly',
  ...
  {
    id: 'co.phonoinc.app.premium.yearly',
  ...
  {
    id: 'co.phonoinc.app.coins.handful',
...
describe('useStoreKit', () => {
  ...
  describe('purchaseProduct - Success Cases', () => {
    it('should successfully purchase a product', async () => {
      ...
      let purchaseResult;
      await act(async () => {
        purchaseResult = await result.current.purchaseProduct('co.phonoinc.app.premium.monthly');
      });
    ...
    it('should restore purchases successfully', async () => {
      mockRestorePurchases.mockResolvedValue({
        ...
        purchases: [
          ...
          {
            productId: 'co.phonoinc.app.premium.yearly',
  ...
  describe('Premium Status Detection', () => {
    ...
    it('should detect weekly subscription correctly', async () => {
      mockGetSubscriptionStatus.mockResolvedValue({
        ...
        activeSubscriptions: [
          {
            productId: 'co.phonoinc.app.premium.weekly',
  ...
  describe('getProductById', () => {
    it('should return product by ID', async () => {
      ...
      const product = result.current.getProductById('co.phonoinc.app.premium.monthly');
